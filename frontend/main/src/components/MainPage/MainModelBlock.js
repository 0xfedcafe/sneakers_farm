...
class MainModelBlock extends React.Component{
  ...
  (() =>{
    switch(name) {
      ...
      break;
              ...
              <Link to = {"/models/"+st.toLink(st.toArr(post.set)) }>
                    ...
                    <div className = "sneakers-block"> {/*начало блока кроссовка*/}
                          ...
                          <div className = "sneakers-block-content"> {/*блок содержимим блока кроссовка*/}
                              ...
                              <div className = "sneakers-block-image"> {/*блок с картинкой кроссовка*/}
                                <img src={post.img} height = "120px" max-width = "100%" className = "sneakers-image"/> {/*картинка кроссовка*/}
                              </div>  {/*конец блок с картинкой кроссовка*/}
                              <div className = "sneakers-block-model-name">Yeezy {post.set} </div> {/*название модели кроссовка*/}
