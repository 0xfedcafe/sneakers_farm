...
class SneakersBlock_2 extends React.Component{
  render () {
...
<Link to = {"/Sneakers/"+st.toLink(st.toArr(post.name_for_search))}>
      ...
      <div className = "sneakers-block" > {/*начало блока кроссовка*/}
            ...
            <div className = "sneakers-block-content"> {/*блок содержимим блока кроссовка*/}
                ...
                <div className = "sneakers-block-image slider-size"> {/*блок с картинкой кроссовка*/}
                  <img src={post.img} height = "120px" max-width = "170px" className = "sneakers-image"/> {/*картинка кроссовка*/}
...
export default SneakersBlock_2;
